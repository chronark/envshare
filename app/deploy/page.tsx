...
const steps: {
    ...
    cta?: React.ReactNode
        ...
        },
        {
            ...
            description: <p>After creating the database, scroll to the bottom and make a note of <code>UPSTASH_REDIS_REST_URL</code> and <code>UPSTASH_REDIS_REST_TOKEN</code>, you need them in the next step</p>
        },
        {
...
export default function Deploy() {
    return (
        <div className="container px-8 mx-auto mt-16 lg:mt-32 ">
            ...
            <p className="mt-4 text-sm text-center text-zinc-600">You can deploy your own hosted version of EnvShare, you just need an Upstash and Vercel account.</p>
            <ol className="flex flex-col items-center justify-center mt-8 md:mt-16 xl:mt-24">
                {steps.map((step, stepIdx) => (
                    <li key={step.name} className="relative flex flex-col items-center gap-4 pb-16 group md:gap-8 md:pb-24">
                        ...
                        <span className="absolute top-4  h-full w-0.5 bg-gradient-to-b from-blue-500/60  via-blue-500/10 to-transparent" aria-hidden="true" />
                        ...
                        <div className="z-10 flex flex-col items-center">
                            ...
                            <div className="w-full mt-8 md:w-auto">
                                {step.cta}
                            </div>
                        </div>
